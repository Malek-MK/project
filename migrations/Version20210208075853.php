 ...
 */
final class Version20210208075853 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE livraison DROP id_commande');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE livraison DROP FOREIGN KEY FK_A60C9F1F19EB6921');
        $this->addSql('ALTER TABLE livraison ADD id_commande INT NOT NULL');
