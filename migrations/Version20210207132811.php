 ...
 */
final class Version20210207132811 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE facture ADD livraison_id INT NOT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_FE8664108E54FB25 ON facture (livraison_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE facture DROP FOREIGN KEY FK_FE86641019EB6921');
        $this->addSql('DROP INDEX IDX_FE8664108E54FB25 ON facture');
        $this->addSql('ALTER TABLE facture DROP livraison_id');
