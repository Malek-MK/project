 ...
 */
final class Version20201228202108 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, designation VARCHAR(50) NOT NULL, resp_comm VARCHAR(50) NOT NULL, resp_finan VARCHAR(50) NOT NULL, adr_liv VARCHAR(100) NOT NULL, adr_facture VARCHAR(100) NOT NULL, tel VARCHAR(14) NOT NULL, portable VARCHAR(14) NOT NULL, fax VARCHAR(14) NOT NULL, email VARCHAR(50) NOT NULL, solde_init DOUBLE PRECISION NOT NULL, solde DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, id_client_id INT NOT NULL, numcom INT NOT NULL, date DATE NOT NULL, tht DOUBLE PRECISION NOT NULL, ttva DOUBLE PRECISION NOT NULL, tttc DOUBLE PRECISION NOT NULL, INDEX IDX_6EEAA67D99DED506 (id_client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
