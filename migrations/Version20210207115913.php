 ...
 */
final class Version20210207115913 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE livraison ADD id_comm_id INT NOT NULL');
        $this->addSql('ALTER TABLE livraison ADD CONSTRAINT FK_A60C9F1F31E31DF9 FOREIGN KEY (id_comm_id) REFERENCES commande (id)');
        $this->addSql('ALTER TABLE livraison ADD CONSTRAINT FK_A60C9F1F19EB6921 FOREIGN KEY (client_id) REFERENCES client (id)');
        $this->addSql('CREATE INDEX IDX_A60C9F1F31E31DF9 ON livraison (id_comm_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE livraison DROP FOREIGN KEY FK_A60C9F1F31E31DF9');
        $this->addSql('ALTER TABLE livraison DROP FOREIGN KEY FK_A60C9F1F19EB6921');
        $this->addSql('DROP INDEX IDX_A60C9F1F31E31DF9 ON livraison');
        $this->addSql('ALTER TABLE livraison DROP id_comm_id');
