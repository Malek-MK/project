 ...
 */
final class Version20210208075804 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE livraison ADD relation_id INT DEFAULT NULL, DROP id_commande');
        $this->addSql('ALTER TABLE livraison ADD CONSTRAINT FK_A60C9F1F3256915B FOREIGN KEY (relation_id) REFERENCES commande (id)');
        $this->addSql('ALTER TABLE livraison ADD CONSTRAINT FK_A60C9F1F19EB6921 FOREIGN KEY (client_id) REFERENCES client (id)');
        $this->addSql('CREATE INDEX IDX_A60C9F1F3256915B ON livraison (relation_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE livraison DROP FOREIGN KEY FK_A60C9F1F3256915B');
        $this->addSql('ALTER TABLE livraison DROP FOREIGN KEY FK_A60C9F1F19EB6921');
        $this->addSql('DROP INDEX IDX_A60C9F1F3256915B ON livraison');
        $this->addSql('ALTER TABLE livraison ADD id_commande INT NOT NULL, DROP relation_id');
